...
# Post.create(author_id: 8, host_id: 4, body: "I'm making mac and cheeze pizza.")
# Post.create(author_id: 4, host_id: 4, body: "We have to remember what's important in life: friends, waffles, and work. Or waffles, friends, work. But work has to come third.")
# Post.create(author_id: 4, host_id: 10, body: "What if he shows up with another woman? What if one of my sleeves catches on fire and it spreads rapidly?")
# Post.create(author_id: 8, host_id: 4, body: "It's a white flag and you may as well start waving it right now--")
# Post.create(author_id: 16, host_id: 5, body: "Have you ever messed with a man's head just to see what you can get him to do for you? We do it all the time, in the library department.")
# Post.create(author_id: 4, host_id: 10, body: "You're a beautiful, talented, brilliant, powerful musk-ox.")
# Post.create(author_id: 13, host_id: 4, body: "You know Spanish right?")
# Post.create(author_id: 4, host_id: 20, body: "Would you like to make a donation to the Pawnee Fund for Disadvantaged Youths?")
# Post.create(author_id: 4, host_id: 4, body: "No matter what I do, literally nothing bad can happen to me. I'm like a white male US Senator.")
# Post.create(author_id: 10, host_id: 4, body: "You made me watch all eight Harry Potter movies. I don't even like Harry Potter.")
# Post.create(author_id: 5, host_id: 5, body: "There’s only one thing I hate more than lying: skim milk. Which is water that’s lying about being milk.")
# Post.create(author_id: 8, host_id: 4, body: "I can't believe I actually defeated Leslie Knope in a gift exchange!")
# Post.create(author_id: 7, host_id: 6, body: "Jesse, it's time to cook.")
# Post.create(author_id: 5, host_id: 4, body: "You know what makes a good person good? When a good person does something bad, they own up to it. They try to learn something from it and move on.")
# Post.create(author_id: 14, host_id: 9, body: "Treat Yo Self")
# Post.create(author_id: 12, host_id: 4, body: "Leslie it says you might have network connectivity issues.")
# Post.create(author_id: 5, host_id: 11, body: "Not only does that thing exist, but now you have deprived everyone of cake.")
# Post.create(author_id: 11, host_id: 4, body: "You are literally the best person I have ever met in my life.")
# Post.create(author_id: 4, host_id: 4, body: "Let's break out of a map. Not the old out-of-date one that shows where we've been, but a crisp new one that show where we might go. Let's embark on a new journey together, and see where it takes us.")

Comment.create(author_id: 4, post_id: 21, body: "That's insane. You love Harry Potter. You've seen all eight movies!")
Comment.create(author_id: 4, post_id: 15, body: "The only thing I'll be waving is your decapitated head on a stick in front of your weeping mother!")
Comment.create(author_id: 12, post_id: 15, body: "Yikes")
Comment.create(author_id: 8, post_id: 15, body: "Good lord.")
Comment.create(author_id: 4, post_id: 28, body: "Take a walk, Ron.")
Comment.create(author_id: 5, post_id: 28, body: "Yep.")
Comment.create(author_id: 5, post_id: 16, body: "To hell with you, woman. Good Bye.")
Comment.create(author_id: 4, post_id: 23, body: "About that...")
Comment.create(author_id: 8, post_id: 23, body: "Oh my God Leslie that is the best gift I've ever received in my life!")
Comment.create(author_id: 9, post_id: 26, body: "Should I buy this bag? It's expensive and I don't need it.")
Comment.create(author_id: 14, post_id: 26, body: "Treat. Yo. Self.")
Comment.create(author_id: 4, post_id: 14, body: "What if instead of Tic Tacs, I accidentally pop a couple of Ambien and I have to keep punching my leg to stay awake?")
Comment.create(author_id: 10, post_id: 14, body: "Those are insane hypotheticals and I promise you they won't happen!")
Comment.create(author_id: 4, post_id: 14, body: "They have happened. All of these have happened to me.")
Comment.create(author_id: 14, post_id: 14, body: "God you're so strange.")
# Comment.create(author_id: , post_id: , body: "")